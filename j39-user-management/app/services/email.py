...
def send_invite_email(*, to_email: str, invite_url: str) -> None:
    ...
    msg = EmailMessage()
    msg["Subject"] = "You’re invited to the SOCOM J39 Forms Application"
    msg["From"] = _from_header()
    msg["To"] = to_email
    text = (
        "You’ve been invited to the SOCOM J39 Forms Application.\n\n"
        f"Accept invite:\n{invite_url}\n\n"
        "If you didn’t request this access, you can ignore this email.\n"
    )
    body_html = f"""\
